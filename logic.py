...
# OPEN PO KPI
# -----------------------------------------------------------------------------
def get_open_po_kpi(engine):

    df = pd.read_sql("SELECT * FROM open_po", engine)
...
# -----------------------------------------------------------------------------
def get_containers_by_destination(engine):

    bookings = load_bookings(engine)
    open_po = pd.read_sql("SELECT * FROM open_po", engine)
...
# -----------------------------------------------------------------------------
def get_pipeline_destination(engine):
...
# -----------------------------------------------------------------------------
def get_eta_delay(engine, df):

    booking = pd.read_sql("SELECT po, eta_port FROM open_po", engine)
